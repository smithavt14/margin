...
// Nothing in the package updates itself, and neither install path does: a global install stays on
// whatever version it was, and npx reuses its cache. So `doctor` is where a stale copy finds out, by
